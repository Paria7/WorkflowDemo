...
{
    public partial class RepositoryWithoutEntityBase<TEntity> : IRepositoryWithoutEntityBase<TEntity> where TEntity:EntityBase1
    {
        #region Fields
        ...
        WorkflowDemoContext IRepositoryWithoutEntityBase<TEntity>.Context => throw new NotImplementedException();
